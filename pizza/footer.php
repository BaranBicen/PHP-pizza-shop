<footer class="bg-body-tertiary text-center">
    ...
    <div class="container p-4 pb-0">
        ...
        <section class="mb-4">
            ...
            <a data-mdb-ripple-init class="btn text-white btn-floating m-1" style="background-color: #55acee;"
                href="https://x.com/MustafaBaranB" role="button"><i class="fab fa-twitter"></i></a>
            ...
            <a data-mdb-ripple-init class="btn text-white btn-floating m-1" style="background-color: #ac2bac;"
                href="https://www.instagram.com/mustafabaranbicen/" role="button"><i class="fab fa-instagram"></i></a>

            <!-- Linkedin -->
            <a data-mdb-ripple-init class="btn text-white btn-floating m-1" style="background-color: #0082ca;"
                href="https://www.linkedin.com/in/mustafabaranbicen/" role="button"><i
                    class="fab fa-linkedin-in"></i></a>
            <!-- Github -->
            <a data-mdb-ripple-init class="btn text-white btn-floating m-1" style="background-color: #333333;"
                href="https://github.com/BaranBicen" role="button"><i class="fab fa-github"></i></a>
        </section>
        <!-- Section: Social media -->
    </div>
    <!-- Grid container -->
    ...
    <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.05);">
        © 2020 Copyright:
        <a class="text-body" href="https://github.com/BaranBicen">Mustafa Baran Biçen</a>
    </div>
    <!-- Copyright -->
</footer>
...
<script src="https://kit.fontawesome.com/f8b1b0b546.js" crossorigin="anonymous"></script>
